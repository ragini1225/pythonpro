...
const Settings = () => {
  ...
  const handleExportData = () => {
    ...
    a.href = url;
    a.download = `pycode-settings-${new Date().toISOString().split('T')[0]}.json`;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <p className="text-slate-400">Create an account to customize your PyCode Pro experience</p>
        </motion.div>
      </div>
    );
  }
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full"
                        />
                        <div className="text-sm text-slate-400 mt-1">{preferences.font_size}px</div>
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setPreferences({ ...preferences, tab_size: parseInt(e.target.value) })}
                    ...
                    <div className="space-y-3">
                      {[
                        { key: 'auto_save', label: 'Auto Save', description: 'Automatically save your work' },
                        { key: 'line_numbers', label: 'Line Numbers', description: 'Show line numbers in editor' },
                        { key: 'word_wrap', label: 'Word Wrap', description: 'Wrap long lines' },
                        { key: 'minimap', label: 'Minimap', description: 'Show code minimap' },
                        { key: 'vim_mode', label: 'Vim Mode', description: 'Enable Vim keybindings' },
                      ].map((setting) => (
                        <div key={setting.key} className="flex items-center justify-between p-4 bg-slate-700/30 rounded-lg">
                          ...
                          <motion.button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                              preferences[setting.key] ? 'bg-emerald-600' : 'bg-slate-600'
                            }`}
                          >
                            <motion.span
                              animate={{
