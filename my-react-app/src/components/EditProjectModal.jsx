...
const EditProjectModal = ({ isOpen, project, onClose, onUpdateProject }) => {
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-xs text-slate-400">Only you can see</div>
                        </div>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-xs text-slate-400">Anyone can see</div>
                        </div>
                      </div>
                    </button>
                  </div>
